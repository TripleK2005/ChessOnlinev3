        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitialTimeSeconds = table.Column<int>(type: "int", nullable: false),
                    IncrementSeconds = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CurrentFen = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastMove = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameLobbies_AspNetUsers_Player1Id",
                        column: x => x.Player1Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GameLobbies_AspNetUsers_Player2Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MatchHistories_AspNetUsers_BlackPlayerId",
                        column: x => x.BlackPlayerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MatchHistories_AspNetUsers_WhitePlayerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Result = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CurrentFen = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MoveHistoryJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WhiteRemainingSeconds = table.Column<int>(type: "int", nullable: false),
                    BlackRemainingSeconds = table.Column<int>(type: "int", nullable: false),
                    StartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GamePlays_AspNetUsers_BlackPlayerId",
                        column: x => x.BlackPlayerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GamePlays_AspNetUsers_WhitePlayerId",
                        column: x => x.WhitePlayerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GamePlays_GameLobbies_LobbyId",
                        column: x => x.LobbyId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameLobbies_Player1Id",
                table: "GameLobbies",
                column: "Player1Id");

            migrationBuilder.CreateIndex(
                name: "IX_GameLobbies_Player2Id",
                table: "GameLobbies",
                column: "Player2Id");

            migrationBuilder.CreateIndex(
                name: "IX_GamePlays_BlackPlayerId",
                table: "GamePlays",
                column: "BlackPlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_GamePlays_LobbyId",
                table: "GamePlays",
                column: "LobbyId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GamePlays_WhitePlayerId",
                table: "GamePlays",
                column: "WhitePlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchHistories_BlackPlayerId",
                table: "MatchHistories",
                column: "BlackPlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchHistories_WhitePlayerId",
                table: "MatchHistories",
                column: "WhitePlayerId");
